...
public class TopRatedRecipesRecyclerAdapter extends RecyclerView.Adapter<TopRatedRecipesRecyclerAdapter.ViewHolder> {
    private final ArrayList<Recipe> recipesList;

    public TopRatedRecipesRecyclerAdapter(Context context, ArrayList<Recipe> recipesList) {
        this.recipesList = recipesList;
    }

    @NonNull
    @Override
    public TopRatedRecipesRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TopRatedRecipesRecyclerAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.recipeItem.setOnClickListener(view -> {
            ...
            Log.d("TopRatedRecipesRecyclerAdapter", recipe.getStrMeal() + " selected");
